...
HOW WOULD YOU BUILD A CITY? 你会如何建造一座城市？
...
SEPARATE CONSTRUCTING A SYSTEM FROM USING IT 将系统的构造与使用分离
...
PURE JAVA AOP FRAMEWORKS 纯 Java AOP 框架
...
USE STANDARDS WISELY, WHEN THEY ADD DEMONSTRABLE VALUE 明智地使用标准，当它们能带来可证明的价值时
